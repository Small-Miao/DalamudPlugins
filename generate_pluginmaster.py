...
DOWNLOAD_URL = "https://github.com/Small-Miao/DalamudPlugins/raw/{branch}/plugins/{plugin_name}/latest.zip"
TESTING_DOWNLOAD_URL = "https://github.com/Small-Miao/DalamudPlugins/raw/{branch}/plugins/{plugin_name}/testing/latest.zip"
# Generic subfolder download URL. Use with subfolder name, e.g. 'global' or other folder.
SUB_DOWNLOAD_URL = "https://github.com/Small-Miao/DalamudPlugins/raw/{branch}/plugins/{plugin_name}/{subfolder}/latest.zip"
